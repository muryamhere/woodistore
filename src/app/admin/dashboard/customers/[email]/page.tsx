...
export default async function CustomerDetailsPage({ params }: { params: { email: string } }) {
  ...
  const lastOrderedDate = customer.lastOrdered
    ? new Date((customer.lastOrdered as unknown as Timestamp).seconds * 1000).toDateString()
    : 'N/A';
    ...
    <div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{lastOrderedDate}</div>
              ...
              {orders.length === 0 ? (
                ...
                orders.map(order => (
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      {order.createdAt ? new Date((order.createdAt as unknown as Timestamp).seconds * 1000).toDateString() : 'N/A'}
                    </TableCell>
                    <TableCell>
